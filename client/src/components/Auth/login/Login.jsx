      ...
      >
        <div className="w-full h-100">
          <div className="inline-flex items-center mt-4">
            ...
            <h1 className="text-xl text-skin-base font-bold">Career Span</h1>
          </div>
          ...
          <form className="mt-6">
            <div>
              ...
              <input
                ...
                required
              />
              {isValidEmail?<p className="text-red-800 text-sm">Please enter correct email address</p>:
              <></>}
            </div>
            ...
            <div className="mt-4">
              ...
              <input
                ...
                required
              />
              {isValidPassword?<p className="text-red-800 text-sm">Password must be at least 8 digits</p>:
              <></>}
            </div>
