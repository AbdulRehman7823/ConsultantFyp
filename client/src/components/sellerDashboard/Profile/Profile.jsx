...
const Profile = () => {
  ...
  const updateInstructor = (e) => {
    ...
    instructorService
      .updateInstructor(authServices.getLoggedInUser()._id, payload)
      .then((data) => {
  ...
  useEffect(() => {
    instructorService
      .getInstructor(authServices.getLoggedInUser()._id)
      .then((data) => {
        console.log(data);
        setData({
          img: data.img,
    ...
    <section class="text-gray-600 py-24 body-font">
      ...
      <div class="container mx-auto flex px-5  md:flex-row flex-col justify-center">
        ...
        <div class="md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          <form className="w-full" onSubmit={updateInstructor}>
            <div class="mb-2">
              <label
                for="email"
