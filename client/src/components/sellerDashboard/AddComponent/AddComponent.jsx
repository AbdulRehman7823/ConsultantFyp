...
function AddComponent() {
  ...
  return (
    <div className="pl-1 h-screen justify-center">
      ...
      <button onClick={()=>{setHide(!hide)}} className="absolute top-2 left-2">
        {!hide?<BsEyeFill className="text-2xl text-gray-200"/>:<BsEyeSlashFill className="text-2xl text-yellow-400"/>}
      </button>
        {hide?<div className="addPanel w-2/3 pr-2 ">
