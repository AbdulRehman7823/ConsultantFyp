...
function Questions() {
  ...
  const [questions, setQuestions] = React.useState([
    {
      questionText: "Choose a univercity",
      questionType: "radio",
      options: [
        { optionText: "Comsats" },
        { optionText: "UOL" },
...
return <div>
            ...
            <Switch checked={checked} onChange={handleCheck} name="gilad" color="warning" />
         ...
         >
          ...
          <div>
            ...
            <select
              ...
              className=" mb-6 bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            >
              <option value="Sad">Option 1</option>
              <option value="Love">Option 2</option>
              <option value="Attitude">Option 3</option>
              <option value="Life">Option 4</option>
            </select>
          </div>

          <button className=" bg-yellow-500  px-12 py-2 font-xl rounded-md shadow-lg text-gray-100" >Save</button>
</div>
                      ...
                      return (
                        <div key={opi}>
                          <FormControlLabel
                            ...
                            label={
                              <h2 className="text-md text-gray-700 p-2">
                                {op.optionText}
                              </h2>
                            }
                          ></FormControlLabel>
  ...
  return (
    <Box className="ml-8" sx={{ width: "100%" }}>
      ...
      <TabPanel value={value} index={1}>
        <Preview data={questions}></Preview>
      </TabPanel>
    </Box>
  );
}
